...
(function (Endabgabe) {
    class Main {
        ...
        static rotationAxis;
        static rotator;
        static rotateSound = new ƒ.Audio("lololo tüü tüüü tüü");
        static backgroundSound = new ƒ.Audio("Zimtstern hahahaha");
        static winSound = new ƒ.Audio("Dri, schinisin mit dim cintribiss");
