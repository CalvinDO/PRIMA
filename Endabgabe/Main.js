...
(function (Endabgabe) {
    class Main {
        ...
        static rotationAxis;
        static rotator;
        static rotateSound = new ƒ.Audio("/PRIMA/Audio/rotate.wav");
        static backgroundSound = new ƒ.Audio("/PRIMA/Audio/background.wav");
        static winSound = new ƒ.Audio("/PRIMA/Audio/win.mp3");
