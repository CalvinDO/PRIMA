namespace Endabgabe {
    ...
    export class Main {
        ...
        public static rotateSound: ƒ.Audio = new ƒ.Audio("/Audio/rotate.wav");
        public static backgroundSound: ƒ.Audio = new ƒ.Audio("/Audio/background.wav");
        public static winSound: ƒ.Audio = new ƒ.Audio("/Audio/win.mp3");
